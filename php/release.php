...
$newsid = (string)date("ymdHis",time());
...
$sql = "INSERT INTO NEWS (NEWS_ID, NEWS_HEADLINE, NEWS_CONTENT, NEWS_KIND, NEWS_AUTHOR, NEWS_TIME) 
VALUES ('$newsid','$headline','$content','$kind','$author','$time')";
